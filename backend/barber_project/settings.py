...
# Default to False for security (safe by default)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'login': config('THROTTLE_RATE_LOGIN', default='5/minute'),  # Custom for login attempts
    },
}
...
# Celery Configuration (preparação futura)
